#!/usr/bin/env python3
"""
Simple SBOMAI Engine Test Examples
...
def test_basic_analysis():
    ...
    try:
        ...
        # Test risk aggregation with correct parameter
        aggregated_risks = graph.aggregate_risk_scores('pkg:maven/org.apache.logging.log4j/log4j-core@2.14.1')
        ...
        # Test critical path analysis with correct parameter
        critical_paths = graph.find_critical_paths('pkg:maven/org.apache.logging.log4j/log4j-core@2.14.1')
...
if __name__ == "__main__":
    print("🚀 SBOMAI Engine Simple Test Suite")
    print("=" * 50)
